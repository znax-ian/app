...
// --- 1. CONFIGURATION ---
const CONFIG = {
    host: 'arcs-vtex.corp.vtex.local', // e.g., 192.168.1.50
    user: 'ian_tsai',
    password: 'V0460'
};
...
async function parseSearchResults(xmlInput) {
    ...
    try {
        ...
        const responseKey = Object.keys(body).find(k => k.toLowerCase().includes('searchrepositoryobjectsresponse'));
        if (!responseKey) return [];

        const returnObj = body[responseKey]['searchRepositoryObjectsReturn'];
        
        // Handle cases with 0, 1, or multiple results
        if (!returnObj) return [];
        let objects = returnObj['repositoryObject'];
        if (!objects) return [];
...
function makeSearchXml(require) {
    if(require.enabledDates){
        const dateFilter = `
        <types:attrCondition xsi:type="types:TrinaryOperatorCondition" operator="BETWEEN">
...
async function getDocList(require) {
    try {        
        ...
        const searchXml = `
            <types:searchRepositoryObjects>
                <types:attrCondition xsi:type="types:TrinaryOperatorCondition" operator="BETWEEN">
                    <types:attributeId name="system:modifiedon" ns="rep" />
                    <types:attributeValue xsi:type="types:DateTimeValue">
                        <types:dateTime>2026-01-28T00:00:00.000Z</types:dateTime>
                    </types:attributeValue>
                    <types:attributeValue xsi:type="types:DateTimeValue">
                        <types:dateTime>2026-01-30T00:00:00.000Z</types:dateTime>
                    </types:attributeValue>
                </types:attrCondition>
                ...
                <types:option>
                    <types:searchRegion>
                        <types:id>${CONFIG.searchRootId}</types:id>
                        <types:depth>0</types:depth>
                    </types:searchRegion>
                </types:option>
                <types:limit>1000</types:limit>
...
<types:searchRepositoryObjects>
    ...
    <types:attrCondition xsi:type="types:AndCondition">
        <types:attributeSearchCondition xsi:type="types:TrinaryOperatorCondition" operator="BETWEEN">
            <types:attributeId name="system:modifiedon" ns="rep" />
            <types:attributeValue xsi:type="types:DateTimeValue">
                <types:dateTime>${CONFIG.fromDate}</types:dateTime>
            </types:attributeValue>
            <types:attributeValue xsi:type="types:DateTimeValue">
                <types:dateTime>${CONFIG.toDate}</types:dateTime>
            </types:attributeValue>
        </types:attributeSearchCondition>

        <types:attributeSearchCondition xsi:type="types:BinaryOperatorCondition" operator="EQUAL">
            <types:attributeId name="system:modifiedby" ns="rep" />
            
            <types:attributeValue xsi:type="types:RmsObjectValueRmsObject">
                <types:rmsObject>
                    <types:id>rms:nimid:11:3db5-0000000021</types:id>
                </types:rmsObject>
            </types:attributeValue>
    ...
    <types:limit>1000</types:limit>
        ...
        `;*/
        const searchXml = makeSearchXml(require);
        ...
        const data = await parseSearchResults(res.data);
        return data;
...
try{
    const searchParams = {
        region: 'rep:ARCSVTEX:21_HINSHO_CAB',
        role: 'system:modifiedby',
        dateAttr: 'system:modifiedon',
        user: 'rms:nimid:11:3db5-0000000301',
        enabledDates: true,
    ...
    console.log(searchParams.dateAttr);
    console.log(searchParams.user);
    console.log(searchParams.enabledDates);
    console.log(searchParams.startDate);
    console.log(searchParams.endDate);
    getDocList(searchParams);
